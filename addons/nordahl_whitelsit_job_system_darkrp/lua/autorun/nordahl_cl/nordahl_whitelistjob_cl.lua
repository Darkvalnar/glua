...
local tra_recherch_job="Vous devez un métier en premier"
...
MakePanelRECH.Paint=function()draw.RoundedBox(4,0,0,ScrW()-24,ScrH()-65,Color(0,125,194,255))
end
local textbox1=vgui.Create("DTextEntry",MakePanelRECH)
textbox1:SetWide(150)
textbox1:SetText("Job Name here")
MakePanelRECH.Box1=textbox1
local butan=vgui.Create("DButton",MakePanelRECH)
butan:SetText("   "..tra_scrprecherche.." Jobs")
butan:SetPos(155,5)
butan:SetWide(150)
butan.Paint=function()
draw.RoundedBox(6,0,0,butan:GetWide(),butan:GetTall(),Color(0,0,0,255))
...
list:AddSheet(tra_scrprecherche.." Jobs",MakePanelRECH,"icon16/zoom.png", false, false,tra_scrprecherched)
