...
------ Core Variables ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
ENT.Model = {"models/kryptonite/npc/death_squad_leader/death_squad_leader.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 200
...
ENT.VJ_NPC_Class = {"CLASS_DTF"} -- NPCs with the same class with be allied to each other
...
ENT.RunFromEnemy_Distance = 5 -- When the enemy is this close, the SNPC will back away | Put to 0, to never back away
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
ENT.SoundTbl_Idle = {"dt/idle1.wav", "dt/idle2.wav", "dt/idle3.wav"}
ENT.SoundTbl_MedicBeforeHeal = {"dt/medic.wav"}
ENT.SoundTbl_CombatIdle = {"dt/combatidle1.wav", "dt/combatidle2.wav"}
ENT.SoundTbl_OnPlayerSight = {"dt/spotted.wav", "dt/spotted2.wav"}
ENT.SoundTbl_CallForHelp = {"dt/help1.wav"}
ENT.SoundTbl_WeaponReload = {"dt/reloading1.wav"}
ENT.SoundTbl_OnGrenadeSight = {"dt/grenade.wav", "dt/grenade2.wav"}
