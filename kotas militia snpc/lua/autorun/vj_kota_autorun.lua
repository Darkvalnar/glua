...
--------------------------------------------------*/
------------------ Addon Information ------------------
local PublicAddonName = "[VJ] Kota's Militia"
local AddonName = "Kota's Militia VJ"
local AddonType = "SNPCs"
local AutorunFile = "autorun/vj_kota_autorun.lua"
-------------------------------------------------------
local VJExists = file.Exists("lua/autorun/vj_base_autorun.lua","GAME")
if VJExists == true then
	include('autorun/vj_controls.lua')

	local vCat = "Kotas Militia Trooper (VJ)" -- Category, you can also set a category individually by replacing the vCat with a string value
	...
	-------------------------------------------------------HOSTILE----------------------------------------------------------------------------
	VJ.AddNPC_HUMAN ("Hostile Kota's Militia Trooper", "npc_vj_kota_hostile",{"weapon_vj_blaster"},"[VJ] Kotas Militia Trooper")
	--------------------------FRIENDLY--------------------------------------------------------------------------------------------------------------------
	VJ.AddNPC_HUMAN ("Friendly Kota's Militia Trooper", "npc_vj_kota_friendly",{"weapon_vj_blaster"},"[VJ] Kotas Militia Trooper")
	...
	VJ.AddNPCWeapon("Blaster", "weapon_vj_e5_edit")	
