...
-----------------------------------------------*/
ENT.Model = {"models/republic/gingers_republic_white/gingers_republic_white_commander.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 135
