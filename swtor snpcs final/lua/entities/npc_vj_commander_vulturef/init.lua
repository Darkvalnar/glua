...
-----------------------------------------------*/
ENT.Model = {"models/republic/gingers_republic_green/gingers_republic_green_commander.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 100
