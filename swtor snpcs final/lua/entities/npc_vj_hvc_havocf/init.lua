...
-----------------------------------------------*/
ENT.Model = {"models/npc/deckboy/havoc_trooper/havoc_trooper.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 150
...
-----------------------------------------------------------------------------------------------------------------
ENT.VJ_NPC_Class = {"CLASS_REPUBLIC"} -- NPCs with the same class with be allied to each other
...
ENT.GrenadeAttackModel = "models/zeus/tdunprimed.mdl" -- The model for the grenade entity
-----------------------------------------------------------------------------------------------------------------
...
ENT.AnimTbl_Walk = {ACT_WALK_RIFLE} -- Set the walking animations | Put multiple to let the base pick a random animation when it moves
...
ENT.Weapon_FiringDistanceFar = 2500 -- How far away it can shoot
...
ENT.SoundTbl_Idle = {"trooper/roger.wav", "trooper/status.wav"}
ENT.SoundTbl_MedicBeforeHeal = {"trooper/medic.wav"}
ENT.SoundTbl_CombatIdle = {"trooper/defend.wav", "trooper/clearit.wav", "trooper/spread.wav", "trooper/breakup.wav"}
ENT.SoundTbl_OnPlayerSight = {"trooper/spotted.wav"}
ENT.SoundTbl_CallForHelp = {"trooper/backup.wav"}
ENT.SoundTbl_WeaponReload = {"trooper/cover.wav"}
ENT.SoundTbl_OnGrenadeSight = {"trooper/spread.wav", "trooper/breakup.wav"}
