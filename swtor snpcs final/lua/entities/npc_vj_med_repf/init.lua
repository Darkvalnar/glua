...
-----------------------------------------------*/
ENT.Model = {"models/republic/gamingbro/characters/reptroopexalted/reptroopexalted.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 90
...
ENT.VJ_NPC_Class = {"CLASS_REPUBLICF"} -- NPCs with the same class with be allied to each other
...
ENT.Medic_CheckDistance = 800 -- How far does it check for allies that are hurt? | World units
