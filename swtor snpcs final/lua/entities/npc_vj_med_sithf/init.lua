...
-----------------------------------------------*/
ENT.Model = {"models/sith/gingers_sith_basic/gingers_sith_basic_trooper.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 90
...
ENT.VJ_NPC_Class = {"CLASS_SITHF"} -- NPCs with the same class with be allied to each other
