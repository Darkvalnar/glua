...
-----------------------------------------------*/
ENT.Model = {"models/npc/creeps/roshan/roshan.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
...
-----------------------------------------------------------------------------------------------------------------
ENT.VJ_NPC_Class = {"CLASS_RANCOR"} -- NPCs with the same class with be allied to each other
...
ENT.MeleeAttackDamageType = DMG_SLASH -- Type of Damage
	-- ====== Animation Variables ====== --
ENT.AnimTbl_MeleeAttack = {"attack_1", "Attack1", "vjseq_attack_1", "Attack2", "Attack3", "Attack4"} -- Melee Attack Animations
...
ENT.LeapAttackDamage = GetConVarNumber("vj_snpcdamage")
ENT.LeapAttackDamageType = DMG_SLASH -- Type of Damage
	-- ====== Animation Variables ====== --
ENT.AnimTbl_LeapAttack = {"attack_1", "Attack1", "vjseq_attack_1", "Attack2"} -- Melee Attack Animations
...
ENT.SoundTbl_MeleeAttack = {"roshan/attack1.mp3", "roshan/attack2.mp3", "roshan_attack3.mp3", "roshan/slam.mp3"}
ENT.SoundTbl_BeforeMeleeAttack = {"roshan/before1.mp3"}
